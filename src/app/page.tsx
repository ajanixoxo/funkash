...
export default function Home() {
  ...
  const splitScene = "https://draft.spline.design/scIIhsl4lKG9Lj8c/scene.splinecode";
  ...
  const rotateY = useTransform(scrollYProgress, scrollKeyframes, [
    0, 
    180, // Spins horizontally when moving to Mission
    360, // Spins horizontally when moving to Services
    360, // Stays looking forward
    360, 
    360, 
    360
  ]);
  ...
  const x = useTransform(scrollYProgress, scrollKeyframes, [
    ...
    "-35%", // Services 1 (Top Left)
    "35%",  // Services 2 (Top Right)
    "-35%", // Services 3 (Bottom Left)
