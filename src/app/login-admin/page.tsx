  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-gray-900 to-blue-950 flex items-center justify-center p-6">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        {/* Footer */}
        <p className="text-center text-gray-400 text-sm mt-6">© 2025 Funkash Technology. All rights reserved.</p>
      </div>
    </div>
  )
}
