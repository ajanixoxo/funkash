...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  useEffect(() => {
    if (isOpen !== undefined && isOpen !== openRef.current) {
      toggleMenu();
    }
    ...
    >
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel transition absolute top-0 right-0 h-full bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px]"
...
@media (max-width: 768px) { 
  .sm-scope .sm-panel-item { 
    ...
    letter-spacing: -1px;
    margin-bottom: 0.5em;
     padding-right: 1.6em; /* INCREASE THIS - more space for numbering */
  }
