            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <input
                  ...
                  onBlur={() => setHoveredField(null)}
                  className={`w-full bg-transparent border-b-2 px-2 ${hoveredField === "phone" ? "border-purple-500" : "border-gray-800"} py-3 px-0 text-white placeholder-gray-400 focus:outline-none transition-colors duration-300`}
